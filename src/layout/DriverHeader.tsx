            ...
            <form className="relative">
              <div className="relative">
                <input
                  ...
                  type="text"
                  placeholder="Search..."
                  className="w-full h-11 pl-10 pr-4 text-sm font-medium text-gray-900 placeholder-gray-500 bg-gray-50 border border-gray-200 rounded-lg dark:bg-gray-800 dark:border-gray-800 dark:text-white dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-brand-500 focus:border-transparent"
                />
